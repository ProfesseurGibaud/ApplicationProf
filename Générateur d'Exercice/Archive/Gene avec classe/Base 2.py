...
DicoExo = {}
for ttype in TType:
    DicoExo[ttype] = {"Facile":5,"Moyen":5,"Dur":5}
DicoExo["Proba"] = {"Facile":0,"Moyen":0,"Dur":0}
...
class Exercice:
    ...
    def EcrireExo(self):  #Enlever les with open pour la version initiale
...
def DevoirComplet(DicoExo,Titre,Auteur,Date,Classe):
    ...
    ListeType(o,DicoExo,Classe,Exo,Correction)
...
def InputClasse():
    ...
    if classe == "seconde" or classe == "Seconde" or classe == 2 or classe ==str(2):
        Classe = "Seconde"
    elif classe =="première" or classe =="Première" or classe =="premiere" or classe == "Premiere" or classe =="Facile" or classe == 1:
        Classe = "Premiere"
