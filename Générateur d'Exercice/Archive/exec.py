...
def Utilisateur():
    ...
    if Compl == 0:
        DevoirComplet([nFac,nMoy,nDur],lieu,titre,auteur,date)
    else:
        [o,Exo,Corr] = Preambule(lieu,titre,auteur,date)
        if InputOuiNon("Voulez vous des Développements ?")==1:
            ListeType(o,TType[0],Liste,lieu)
        if InputOuiNon("Voulez vous des Inéquations ?")==1:
            ListeType(o,TType[1],Liste,lieu)
        if InputOuiNon("Voulez vous des Equations ?")==1:
            ListeType(o,TType[2],Liste,lieu)
        if InputOuiNon("Voulez vous des Tableaux de Variations ?")==1:
            ListeType(o,TType[3],Liste,lieu)
        if InputOuiNon("Voulez vous des Fractions ?")==1:
            ListeType(o,TType[4],Liste,lieu)
