...
def restart():
    ...
    return [ListePunis,ListeNomPunis,ListePrenomPunis,Rappo,Feuille,ListeMotifs,ClasseEnCours,LabelPunisSeconde,labelmotif,TexteMotif,TextInputVerif,CompteurRapport,LabelEleve,ListeSeconde,Salle,Prof,Dico,DicoLabel,TextInputSanction,TextInputPunition]

[ListePunis,ListeNomPunis,ListePrenomPunis,Rappo,Feuille,ListeMotifs,ClasseEnCours,LabelPunisSeconde,labelmotif,TexteMotif,TextInputVerif,CompteurRapport,LabelEleve,ListeSeconde,Salle,Prof,Dico,DicoLabel,TextInputSanction,TextInputPunition] = restart()
...
class BoutonsEtLabelMotif(BoxLayout):
    ...
    def VersVerification(self, instance):
        ...
        for i in range(len(ListePunis)):
            ...
            Rappo[i].punition = "Pour Information" * (len(ListeMotifs) == 1) + "{0} heures de colle".format(len(ListeMotifs) - 1)*(len(ListeMotifs)>1)
